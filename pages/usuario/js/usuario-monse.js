...
function cambiarTipo(boton, tipo) {
  ...
  if (crearCuenta) {
    if (tipo === "empresa") {
      ...
      crearCuenta.href = "../empresas/Registro-Cuenta-Empresarial.html"; 
    } 
    else if (tipo === "usuario") {
      crearCuenta.textContent = "Crea una cuenta";
      crearCuenta.href = "Registro-usuarios.html"; 
    } 
    else {
...
function login() {
  ...
  if (tipo === "usuario") {
    ...
    window.location.href = "../empresas/Paquetes-empresariales.html";
  }
}
